...
# Contract error codes. Only the codes Phase 1 can actually emit are defined
# here; CLOCK_SKEW_FUTURE and EVENT_TOO_OLD arrive with `received_at` in Phase 2.
...
#: Phase 1 only. Removed as each capability is implemented.
